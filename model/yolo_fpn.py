...
class FPN_YOLOV3(nn.Module):
    ...
    def __init__(self, fileters_in, fileters_out):
        ...
        # large
        self.__conv_set_0 = nn.Sequential(
            Convolutional(filters_in=fi_0, filters_out=128, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
        ...
        self.__conv0_0 = Convolutional(filters_in=128, filters_out=256, kernel_size=3, stride=1,
                                       pad=1, norm="bn", activate="leaky")
        self.__conv0_1 = Convolutional(filters_in=256, filters_out=fo_0, kernel_size=1,
                                       stride=1, pad=0)

        self.__conv0 = Convolutional(filters_in=128, filters_out=64, kernel_size=1, stride=1, pad=0, norm="bn",
                                      activate="leaky")
        self.__upsample0 = Upsample(scale_factor=2)
        self.__route0 = Route()
        ...
        self.__conv_set_1 = nn.Sequential(
            Convolutional(filters_in=fi_1+64, filters_out=64, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=64, filters_out=128, kernel_size=3, stride=1, pad=1, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=128, filters_out=64, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=64, filters_out=128, kernel_size=3, stride=1, pad=1, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=128, filters_out=64, kernel_size=1, stride=1, pad=0, norm="bn",
        ...
        self.__conv1_0 = Convolutional(filters_in=64, filters_out=128, kernel_size=3, stride=1,
                                       pad=1, norm="bn", activate="leaky")
        self.__conv1_1 = Convolutional(filters_in=128, filters_out=fo_1, kernel_size=1,
                                       stride=1, pad=0)   # >> out1


        self.__conv1 = Convolutional(filters_in=64, filters_out=32, kernel_size=1, stride=1, pad=0, norm="bn",
                                     activate="leaky")
        ...
        self.__conv_set_2 = nn.Sequential(
            Convolutional(filters_in=fi_2+32, filters_out=32, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=32, filters_out=64, kernel_size=3, stride=1, pad=1, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=64, filters_out=32, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=32, filters_out=64, kernel_size=3, stride=1, pad=1, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=64, filters_out=32, kernel_size=1, stride=1, pad=0, norm="bn",
        ...
        self.__conv2_0 = Convolutional(filters_in=32, filters_out=64, kernel_size=3, stride=1,
                                       pad=1, norm="bn", activate="leaky")
        self.__conv2_1 = Convolutional(filters_in=64, filters_out=fo_2, kernel_size=1,
                                       stride=1, pad=0)
